...
export const other = require('../assets/icons/clipboard.png')
export const entertainment = require('../assets/icons/mental-health.png')
export const bills = require('../assets/icons/bill.png')
